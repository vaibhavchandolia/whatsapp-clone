    ...
    <div className="flex items-center justify-center">
      ...
      {type === "xl" && (
        <div className="relative cursor-pointer z-0"
          ...
          id="context-opener"
        >
          <div className={`z-10 bg-photopicker-overlay-background absolute h-60 w-60 top-0 left-0 flex items-center rounded-full justify-center flex-col text-center gap-2
